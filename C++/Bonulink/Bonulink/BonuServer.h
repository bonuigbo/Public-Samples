...
//======================================================================
// BonuServer will play around with raw sockets
//======================================================================
class BonuServer
{
private:
	vector<Connection> _connection_list;		// List of connections
	char* _address;
	int _port;
...
public:
	BonuServer() : _address(0), _port(20202), _server_socket(INVALID_SOCKET),
		_remote_socket(INVALID_SOCKET) {}

	BonuServer( char* address, int port ) : _address(address), _port(port),
